...
<<<<<<< HEAD
      ...
      setError("Failed to synchronize enrollment records."); 
    }
=======
<<<<<<< HEAD
...
<<<<<<< HEAD
      const endpoint = editingId 
        ? `${BACK_URL}/api/admin/enrollments/${editingId}` 
        : `${BACK_URL}/api/admin/enrollments`;
=======
...
>>>>>>> 16cb5ced5963fb7d62ed500a1e58d4124ecd8949
  ...
  const handleDelete = async (id) => {
    ...
    try {
<<<<<<< HEAD
      await axios.delete(`${BACK_URL}/api/admin/enrollments/${id}`, {
        headers: { "x-admin-token": ADMIN_TOKEN },
      });
...
<<<<<<< HEAD
          <p className="text-slate-500 font-medium mt-1">Management of student course provisioning.</p>
=======
