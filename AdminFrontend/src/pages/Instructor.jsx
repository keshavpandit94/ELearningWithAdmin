...
=======
<<<<<<< HEAD
    const config = { headers: { "x-admin-token": ADMIN_TOKEN, "Content-Type": "multipart/form-data" } };
>>>>>>> 16cb5ced5963fb7d62ed500a1e58d4124ecd8949
...
=======
  ...
  const deleteInstructor = (id) => {
    if (!window.confirm("Remove instructor from platform faculty?")) return;
    axios.delete(`${BACK_URL}/api/admin/instructors/${id}`, { headers: { "x-admin-token": ADMIN_TOKEN } })
>>>>>>> 16cb5ced5963fb7d62ed500a1e58d4124ecd8949
...
=======
                            <img src={inst.profilePicture.url} className="w-full h-full object-cover" alt="" />
>>>>>>> 16cb5ced5963fb7d62ed500a1e58d4124ecd8949
                          ) : (
...
=======
                      if (file) { setProfilePic(file); setProfilePicPreview(URL.createObjectURL(file)); }
>>>>>>> 16cb5ced5963fb7d62ed500a1e58d4124ecd8949
                    }} />
                  </label>
                </div>
