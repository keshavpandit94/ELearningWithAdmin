...
<<<<<<< HEAD
      className={`relative w-full flex items-center justify-center gap-3 px-8 py-5 rounded-2xl font-bold transition-all duration-300 mb-4 overflow-hidden group ${
=======
