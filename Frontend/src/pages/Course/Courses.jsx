...
<<<<<<< HEAD
  ...
  useEffect(() => {
    ...
    // If logged in, fetch current user's enrolled courses to show status
=======
<<<<<<< HEAD
  useEffect(() => {
    setLoading(true);
...
<<<<<<< HEAD
              <p className="text-slate-500 mt-1">Try adjusting your search or filters matching "{searchTerm}".</p>
=======
