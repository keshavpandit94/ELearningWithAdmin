...
<<<<<<< HEAD
      .catch(() => setError("Failed to load your learning dashboard. Please try again later."))
...
<<<<<<< HEAD
  if (loading) return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#fafafa]">
      ...
      <p className="text-slate-500 font-bold uppercase tracking-widest text-[10px]">Syncing Your Progress</p>
=======
<<<<<<< HEAD
  if (loading) return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#fafafa]">
